...
------------- | ------------- | -------------
[**export_folio_pdf**](ExportApi.md#export_folio_pdf) | **POST** /fiscal-document/v1/folios/export | Export folio transactions as PDF
...
# **export_folio_pdf**
> bytearray export_folio_pdf(x_property_id, get_folio_export_request, accept_language=accept_language)
...
with cloudbeds_fiscal_document.ApiClient(configuration) as api_client:
    ...
    try:
        # Export folio transactions as PDF
        api_response = api_instance.export_folio_pdf(x_property_id, get_folio_export_request, accept_language=accept_language)
        print("The response of ExportApi->export_folio_pdf:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ExportApi->export_folio_pdf: %s\n" % e)
```

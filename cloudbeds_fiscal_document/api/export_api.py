...
class ExportApi:
    ...
    def export_folio_pdf(
        ...
        _param = self._export_folio_pdf_serialize(
    ...
    @validate_call
    def export_folio_pdf_with_http_info(
        self,
        x_property_id: Annotated[int, Field(strict=True, ge=1, description="Property id")],
        get_folio_export_request: GetFolioExportRequest,
        accept_language: Annotated[Optional[StrictStr], Field(description="Desired language of exported PDF")] = None,
    ...
    @validate_call
    def export_folio_pdf_without_preload_content(
        self,
        x_property_id: Annotated[int, Field(strict=True, ge=1, description="Property id")],
        get_folio_export_request: GetFolioExportRequest,
        accept_language: Annotated[Optional[StrictStr], Field(description="Desired language of exported PDF")] = None,
    ...
    def _export_folio_pdf_serialize(
        self,
        x_property_id,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/fiscal-document/v1/folios/export',

...
class FiscalizationListResponse(BaseModel):
    """
    FiscalizationListResponse
    """ # noqa: E501
    property_id: Optional[StrictInt] = Field(default=None, alias="propertyId")
    configs: Optional[List[FiscalizationRegistrationResponse]] = Field(default=None, description="List of fiscalization registrations for this property")
    __properties: ClassVar[List[str]] = ["propertyId", "configs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "configs": [FiscalizationRegistrationResponse.from_dict(_item) for _item in obj["configs"]] if obj.get("configs") is not None else None
        })
        return _obj

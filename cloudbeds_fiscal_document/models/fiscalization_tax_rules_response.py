...
class FiscalizationTaxRulesResponse(BaseModel):
    """
    FiscalizationTaxRulesResponse
    """ # noqa: E501
    country: CountryInfo
    taxes: List[TaxRule] = Field(description="Flat list of selectable tax category + rate combinations")
    __properties: ClassVar[List[str]] = ["country", "taxes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "taxes": [TaxRule.from_dict(_item) for _item in obj["taxes"]] if obj.get("taxes") is not None else None
        })
        return _obj

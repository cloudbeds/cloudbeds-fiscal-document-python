...
class FiscalizationTaxResponse(BaseModel):
    """
    FiscalizationTaxResponse
    """ # noqa: E501
    taxes: Optional[List[TaxMapping]] = None
    __properties: ClassVar[List[str]] = ["taxes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "taxes": [TaxMapping.from_dict(_item) for _item in obj["taxes"]] if obj.get("taxes") is not None else None
        })
        return _obj
